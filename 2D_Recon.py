...
def driver(): 
    ...
    # UQpol_array                 = dg.wave_3d(amplitude=1, frequency=1, box_length=8, z_contribution=0.5, visual=0, plotdex='xy')
    ...
    rf.visualize_25d(d3_field[0], d3_field[1], d3_field[2], name='Reconstructed 2.5D '+ilabel, plotdex='xy')
    rf.visualize_slice(d3_field[0], d3_field[1], label=ilabel, plotdex='xy') #NOT WORKING
    # ------------------------------------------------------------------------------------
    # ------------------------------------------------------------------------------------
    # # Loop test:
    # ------------------------------------------------------------------------------------
